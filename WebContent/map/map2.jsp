        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                 ...
                 <li>
                 <a href="../staffindex/index.jsp"><i class="fa fa-th-large"></i> <span class="nav-label">首页</span></a>
                </li>
                      <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                     <li><a href="../staffindex/shebeizong.jsp">设备总运行状态</a></li>
                        <li><a href="../staffindex/bianyaqi.jsp">变压器</a></li>
                      <li><a href="../staffindex/gaoyabianyaxiang.jsp">高压变电箱</a></li>
                        <li><a href="../staffindex/shiduchuanganqi.jsp">湿度传感器</a></li>
                    <li><a href="../staffindex/wenduchuanganqi.jsp">温度传感器</a></li>
                        <li><a href="../staffindex/chaofuhe.jsp">超负荷运行设备<span class="pull-right label label-danger">Warning</span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">设备管理</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="../staffindex/addshebei.jsp">添加设备</a></li>
                        <li><a href="../staffindex/shanchushebei.jsp">删除设备</a></li>
                        <li><a href="../staffindex/resetshebei.jsp">修改设备状态</a></li>
                    </ul>
                </li>
                 <li>
                 <a href="../index/upload.jsp"><i class="fa fa-diamond"></i> <span class="nav-label">决策分析系统</span></a>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="../staffindex/daka.jsp">签到</a></li>
                        <li><a href="../staffindex/qingjia.jsp">请假</a></li>
               ...
               <li>
                    <a href="map2.jsp"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">作者所在地</span><span class="fa arrow"></span></a>
