...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">超负荷负载设备状态表</h2>
    ...
    String sql1="select * from equipmentInFo where statement='超负荷运行'; ";
...
<span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
		...
		<td style="color: red"><%=rs.getString("statement")%></td>
		<td><%=rs.getString("price")%></td>
	<td><button onclick="fun2(<%=rs.getString("EID")%>)" type="button" class="btn btn-primary">复位</button>
	</td>  
...
<form action="Checkresetshebei.jsp" style="display: none;">
