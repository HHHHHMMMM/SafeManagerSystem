...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">后勤人员打卡情况一览表</h2>
    ...
    String sql1="update staff set statement='未打卡' ";
   st.executeUpdate(sql1); 
   response.sendRedirect("viewdaka.jsp");
	%>
 ...
 <a href="chongzhidaka.jsp"><button type="button" class="btn btn-primary">重置打卡</button></a> 
 <a href="chongzhiqingjia.jsp"><button type="button" class="btn btn-info">重置请假</button></a> 
</div>
