                ...
                <li class="nav-header">
                 ...
                 <a href="index.jsp"><i class="fa fa-th-large"></i> <span class="nav-label">首页</span></a>
                    ...
                    <li><a href="shebeizong.jsp">设备总运行状态</a></li>
                      ...
                      <li><a href="chaofuhe.jsp">超负荷运行设备</a><span class="pull-right label label-danger">Warning</span></li>
        ...
        <div class="navbar-header">
         ...
         <li class="dropdown">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2 style="text-align: center;">删除设备</h2>
                    <ol class="breadcrumb">
...
<%
    ...
    Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?character=UTF-8", "root", "");
    
    
    Statement st=conn.createStatement();
    String sql1="select * from equipmentInFo";
    ResultSet rs=st.executeQuery(sql1); 
	rs.last();%>
	
	
	<table class="table table-striped table-bordered table-hover">
	<br><span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
       ...
       <div class="ibox-content">
                            <form method="get" class="form-horizontal" action="checkdelshebei.jsp" id="form">
...
<script>
	...
	function fun1(){
		...
		if(window.confirm("您确定要删除该设备吗？")==1){
			$("#form").submit();
			alert("删除成功！");
			return true;
		}
