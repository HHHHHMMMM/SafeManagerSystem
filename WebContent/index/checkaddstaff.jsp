...
String fanwei=request.getParameter("stafffanwei");

 	Class.forName("com.mysql.jdbc.Driver");  
   Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");
 
   PreparedStatement pst=conn.prepareStatement("insert into staff(staffid,userName,email,password,fanwei) values(?,?,?,?,?)");
  pst.setString(1, staffid);
 pst.setString(2, staffname);
 pst.setString(3, staffemail);
  pst.setString(4,staffpassword);
  pst.setString(5, fanwei);
 pst.executeUpdate();
