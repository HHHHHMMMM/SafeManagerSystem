...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                 <a href="index.jsp"><i class="fa fa-th-large"></i> <span class="nav-label">首页</span></a>
                      ...
                      <li>
                    <a href="#"><i class="fa fa-envelope"></i> <span class="nav-label">企业基础信息库及状态 </span><span class="pull-right label label-danger">Warning</span></a>
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">后勤人员请假情况一览表</h2>
    ...
    String sql1="select * from qingjiareason ";
...
<span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
	...
	<td><button onclick="fun2(<%=rs.getString("staffid")%>)" type="button" class="btn btn-primary">是</button>
	<button onclick="fun3(<%=rs.getString("staffid")%>)" type="button" class="btn btn-danger">否</button></td>  
...
<form action="yesqingjia.jsp" style="display: none;">
<input type="hidden" id="dom_id_input" name="id_to_submit" value="0">
<input type="submit" id="btn_submit">
</form>
<form action="noqingjia.jsp">
<input type="hidden" id="dom_id_input1" name="id_to_submit1" value="0">
<input type="submit" id="btn_submit1">
</form>
    <!-- Mainly scripts -->
...
{
	//alert(idIn);
	document.getElementById("dom_id_input").value=idIn;
	document.getElementById("btn_submit").click();
}
function fun3(idIn)
{
	//alert(idIn);
	document.getElementById("dom_id_input1").value=idIn;
	document.getElementById("btn_submit1").click();
}
