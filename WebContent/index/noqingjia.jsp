      ...
      <li>
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-12">
			<%
			String id=request.getParameter("id_to_submit1");
			System.out.print(id);
 	Class.forName("com.mysql.jdbc.Driver");  
    Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");
   // Statement st=conn.createStatement();
   PreparedStatement pst=conn.prepareStatement("update staff set pizhun='不批准' where staffid=?");/*更新staff表中的批准请假*/
    pst.setString(1,id);
    pst.executeUpdate();
     response.sendRedirect("viewqingjia.jsp");
	%>
	<br>
