...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
			...
			String fanwei=request.getParameter("fanwei123");
   ...
   PreparedStatement pst=conn.prepareStatement("update staff set fanwei=? where staffid=?");/*更新staff表中的批准请假*/
   pst.setString(1,fanwei);
   pst.setString(2,id);
    pst.executeUpdate();
