    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-12">
			<%
			String id=request.getParameter("id_to_submit");
			System.out.print(id);
 	Class.forName("com.mysql.jdbc.Driver");  
    Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");
   // Statement st=conn.createStatement();
   PreparedStatement pst=conn.prepareStatement("update equipmentInFo set statement='正常' where EID=?");/*更新staff表中的批准请假*/
    pst.setString(1,id);	
    pst.executeUpdate();
     response.sendRedirect("resetshebei.jsp");
	%>
	<br>
