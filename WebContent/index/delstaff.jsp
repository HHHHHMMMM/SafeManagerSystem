    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">删除后勤人员</h2>
		 ...
		 conn.close();
		  ...
		  %>
                ...
                <div class="ibox-content">
                            <form method="get" class="form-horizontal" action="checkdelstaff.jsp" id="form">
                                <div class="form-group"><label class="col-sm-2 control-label">删除的人员编号</label>

                                    <div class="col-sm-10"><input name="staffID" type="text" class="form-control" ></div>
                                </div>
                                 </form>
                                <div class="hr-line-dashed"></div>
                                  <a  class="pull-right"  ><button id="shanchu"  class="btn btn-danger " onclick="fun1()" >一键删除</button></a>
...
function fun1(){
	...
	if(window.confirm("您确定要删除该人员吗？")==1){
		$("#form").submit();
		alert("删除成功！");
		return true;
	}
