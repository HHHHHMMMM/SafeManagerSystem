    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">决策分析文件上传</h2>
                    
                </div>
                
                <div class="col-lg-12">
                <div style="text-align: right;">
                <font face="Microsoft YaHei" color="black" size="3" >当前上传用户：</font><%=topusername %><br/>
                </div>
                  
     <form action="/SIMM/UploadHandleServlet" enctype="multipart/form-data" method="post">
     <label class="control-label">文件1</label>
    <input name="file1" type="file" class="file" />
    <br><br>
    <label class="control-label">文件2</label>
     <input name="file2" type="file" class="file" />
     <br><br>
     <input type="submit" class="btn btn-primary pull-right" value="上传文件">
</form>
