    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">更新员工信息</h2>
...
<span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
		...
		<td><%=rs.getString("qingjia")%></td>
		<td><%=rs.getString("pizhun")%></td>
		
		<td><%=rs.getString("fanwei")%> </td>
 ...
 <div class="ibox-content">
                            <form method="get" class="form-horizontal" action="CheckUpdateStaff.jsp">
                                <div class="form-group"><label class="col-sm-2 control-label">人员编号</label>

                                    <div class="col-sm-4"><input name="staffid" type="text" class="form-control" required="required"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">监管范围</label>
                                    <div class="col-sm-10"><input name="fanwei123" type="text" class="form-control" required="required"> 
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <a href="CheckUpdateStaff.jsp" class="pull-right" onclick="fun1()"><button type="submit" class="btn btn-danger ">一键修改</button></a> 
                                </div>
                            </form>
                            </div>
        <div class="footer">
