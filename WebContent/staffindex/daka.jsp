    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">后勤人员信息一览表</h2>
...
<span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
		...
		<%
		 ...
		 <td><%=rs.getString("statement")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="checkdaka.jsp" id ="daka"  class="btn btn-primary btn-sm" type="submit" onclick="fun1()">立刻打卡</a></td>
    ...
    function fun1(){
    	...
    	daka.innerHTML="已打卡";
    		...
    		daka.setAttribute('disabled', true);
