    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">后勤人员请假表</h2>
...
<%
    ...
    String sql1="select * from staff where userName='"+topusername+"'";
...
<span class="pull-right">共有<%=rs.getRow() %>条信息</span> 
		...
		<%
		 ...
		 <td><%=rs.getString("qingjia")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="checkqingjia.jsp" id="qingjia" class="btn btn-primary btn-sm" type="submit" onclick="fun2()">现在请假</a></td>
