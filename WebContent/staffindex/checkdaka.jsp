    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                  <h2 style="text-align: center;">后勤人员信息一览</h2>
...
<%
 String driver = "com.mysql.jdbc.Driver";  
    ...
    conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");  
    sql =conn.prepareStatement("update staff set statement='已打卡' where userName=?");
    sql.setString(1,topusername);
    sql.executeUpdate();
    ...
    function fun1(){
    	...
    	daka.setAttribute('disabled', 'disabled');
