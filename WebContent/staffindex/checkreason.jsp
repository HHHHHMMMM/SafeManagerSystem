...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
           ...
           try{
  String reason=request.getParameter("doc_topost");
String staffid=(String)session.getAttribute("staffID");
String userName=(String)session.getAttribute("userName");
        
  System.out.println(request.getParameter("doc_topost"));
         
 	Class.forName("com.mysql.jdbc.Driver");  
   Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");
    Statement st=conn.createStatement();
   String sql2="insert into qingjiareason(staffid,staffname,reason) values ('"+staffid+"','"+userName+"','"+reason+"')";
