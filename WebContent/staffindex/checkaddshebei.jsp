...
String shebeimingcheng=request.getParameter("shebeimingcheng");
System.out.println(shebeimingcheng);
String shebeixinghao=request.getParameter("shebeixinghao");
String chuchangriqi=request.getParameter("chuchangriqi");
String gongzuohuanjing=request.getParameter("gongzuohuanjing");
String shebeichandi=request.getParameter("shebeichandi");
String gongzuozhuangtai=request.getParameter("gongzuozhuangtai");
String chengbenjiage=request.getParameter("chengbenjiage");
 	Class.forName("com.mysql.jdbc.Driver");  
   Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/Myjdbc?characterEncoding=UTF-8", "root", "");
   PreparedStatement pst=conn.prepareStatement("insert into equipmentInFo(EID,EName,Everion,Efactory,EBuiltData,Everment,statement,price) values(?,?,?,?,?,?,?,?)");
  pst.setString(1, shebeibianhao);
 pst.setString(2, shebeimingcheng);
 pst.setString(3, shebeixinghao);
  pst.setString(4,shebeichandi);
  pst.setString(5, chuchangriqi);
 pst.setString(6, gongzuohuanjing);
 
 pst.setString(7, gongzuozhuangtai);
 pst.setString(8, chengbenjiage);
 pst.executeUpdate();
 response.sendRedirect("shebeizong.jsp");
